<template>
  <div :class="{ 'fade-in': showWorkArea }" class="new-div">
    ...
    <BaseData
      v-if="activeComponent === 'BaseData'"
      @show-ref="activeComponent = 'RefProfileData'"
    />
    <RefProfileData
      v-if="activeComponent === 'RefProfileData'"
      @show-hardware="activeComponent = 'HardwareData'"
      @go-back="activeComponent = 'BaseData'"
    />
    <HardwareData
      v-if="activeComponent === 'HardwareData'"
      @go-back="activeComponent = 'RefProfileData'"
      @show-software="activeComponent = 'SoftwareData'"
    />
    <SoftwareData
      v-if="activeComponent === 'SoftwareData'"

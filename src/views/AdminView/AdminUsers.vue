        ...
        <div class="search-section">
          ...
          <div class="filter-controls">
            <select v-model="selectedRole" class="filter-select">
              ...
              <option v-for="role in roles" :key="role.RollenID" :value="role.RollenID">
                {{ role.Bezeichnung }}
              </option>
            </select>
          ...
          <form @submit.prevent="addUser">
            ...
            <div class="form-group">
              ...
              <select v-model="newUser.TeamID" class="form-input" :disabled="!newUser.BereichID">
                ...
                <option v-for="team in teamsForNewUser" :key="team.TeamID" :value="team.TeamID">
                  {{ team.Bezeichnung }}
                </option>
              </select>
            </div>
          ...
          <form @submit.prevent="updateUser">
            ...
            <div class="form-group">
              ...
              <select
                ...
                class="form-input"
                :disabled="!editingUser.BereichID"
              >
                <option value="">Team wählen</option>
...
onMounted(async () => {
  await Promise.all([adminStore.usersOps.load(), loadBereiche(), loadTeams(), loadRoles()])
})
</script>

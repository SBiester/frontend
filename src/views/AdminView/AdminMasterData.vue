...
<div>
		...
		<div class="masterdata-management">
			...
			<div v-if="activeTab === 'bereiche'" class="tab-content">
				...
				<div class="data-table-container">
					<table class="data-table">
						...
						<tbody>
							<tr v-for="bereich in adminStore.bereiche" :key="bereich.BereichID" class="table-row">
			...
			<div v-if="activeTab === 'teams'" class="tab-content">
				<div class="section-header">
					...
					<button @click="openTeamModal" class="add-button" :disabled="adminStore.bereiche.length === 0">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
							<path d="M12 5v14m7-7H5"></path>
						</svg>
						Neues Team
			...
			<div v-if="activeTab === 'funktionen'" class="tab-content">
				<div class="section-header">
					...
					<button @click="openFunktionModal" class="add-button" :disabled="adminStore.teams.length === 0">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
							<path d="M12 5v14m7-7H5"></path>
						</svg>
						Neue Funktion
				...
				<div class="data-table-container">
					<table class="data-table">
						...
						<tbody>
							<tr v-for="funktion in adminStore.funktionen" :key="funktion.FunktionID" class="table-row">
	...
	>
		<div class="form-group">
			...
			<input
				id="bereich-name"
				v-model="formData.bereich.Bereich"
				type="text"
				class="form-input"
				required
	...
	>
		...
		<div class="form-group">
			...
			<select
				id="team-bereich"
				v-model="formData.team.BereichID"
				class="form-input"
				required
			>
				<option value="">Bereich auswählen</option>
				<option v-for="bereich in adminStore.bereiche" :key="bereich.BereichID" :value="bereich.BereichID">
					{{ bereich.Bereich }}
				</option>
			</select>
		</div>
	...
	>
		<div class="form-group">
			...
			<input
				id="funktion-name"
				v-model="formData.funktion.Funktion"
				type="text"
				class="form-input"
				required
		...
		<div class="form-group">
			...
			<select
				id="funktion-team"
				v-model="formData.funktion.TeamID"
				class="form-input"
				required
			>
...
export default defineComponent({
  ...
  setup() {
    ...
    const openTeamModal = () => {
      ...
      formData.team = { Team: '', BereichID: '' }
      modalState.team = true
    }

    const editTeamModal = (team) => {
      isEditing.team = true
      formData.team = { Team: team.Team, BereichID: team.BereichID }
    ...
    const openFunktionModal = () => {
      ...
      formData.funktion = { Funktion: '', TeamID: '' }
      modalState.funktion = true
    }

    const editFunktionModal = (funktion) => {
      isEditing.funktion = true
      formData.funktion = { Funktion: funktion.Funktion, TeamID: funktion.TeamID }

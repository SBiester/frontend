      ...
      <form @submit.prevent="addCategory">
        ...
        <div class="modal-actions">
          ...
          <button type="submit" class="btn-primary">
            {{ editingCategory ? 'Aktualisieren' : 'Kategorie hinzufügen' }}
          </button>
        </div>
      </form>
    </BaseModal>
      ...
      <form @submit.prevent="addHardware">
        ...
        <div class="form-group">
          ...
          <select v-model="newHardware.category_id" required class="form-input">
            ...
            <option
              v-for="category in adminStore.hardwareCategories"
              :key="category.id"
              :value="category.id"
            >
              {{ category.name }}
        ...
        <div class="form-group">
          ...
          <small class="form-help"
            >Maximale Anzahl, die von diesem Hardware-Typ bestellt werden darf. Leer lassen für
            unbegrenzte Bestellungen.</small
          >
        </div>
        <div class="modal-actions">
          <button type="button" @click="closeModals" class="btn-secondary">Abbrechen</button>
          <button type="submit" class="btn-primary">
            {{ editingHardware ? 'Aktualisieren' : 'Hardware hinzufügen' }}
          </button>
        </div>
      </form>
    </BaseModal>

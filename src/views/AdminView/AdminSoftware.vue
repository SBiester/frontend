      ...
      <form @submit.prevent="addManufacturer">
        ...
        <div class="modal-actions">
          ...
          <button type="submit" class="btn-primary">
            {{ editingManufacturer ? 'Aktualisieren' : 'Hersteller hinzufügen' }}
          </button>
        </div>
      </form>
    </BaseModal>
      ...
      <form @submit.prevent="addSoftware">
        ...
        <div class="form-group">
          ...
          <select v-model="newSoftware.manufacturer_id" required class="form-input">
            ...
            <option
              v-for="manufacturer in adminStore.manufacturers"
              :key="manufacturer.id"
        ...
        <div class="modal-actions">
          <button type="button" @click="closeModals" class="btn-secondary">Abbrechen</button>
          <button type="submit" class="btn-primary">
            {{ editingSoftware ? 'Aktualisieren' : 'Software hinzufügen' }}
          </button>
        </div>
      </form>
    </BaseModal>
            ...
            >
              ...
              <div class="manufacturer-stats">
                ...
                <span class="stat-badge"
                  >{{ manufacturer.software_count }} Software-Anwendungen</span
                >
              </div>
            </div>
          </div>
                ...
                <tr v-for="item in filteredSoftware" :key="item.id" class="software-row">
                  ...
                  <td>
                    <span class="manufacturer-badge">{{
                      getManufacturerName(item.manufacturer_id)
                    }}</span>
                  </td>
                  <td class="text-right">

	...
	<div class="home-view-container">
			...
			<div v-if="!showJobView">
				...
				<div class="navigation-content">
					...
					<div class="dashboard-feature-list">
						...
						<div v-if="userStore.canAccessJobUpdates" class="feature-item clickable" @click="showJobUpdate">
							<i class="fa fa-user feature-icon"></i>
							<span class="feature-text">Job-Update</span>
						</div>
						<div v-if="userStore.canAccessOrders" class="feature-item clickable" @click="navigateToOrders">
		...
		<template v-else>
			...
			<div class="navigation-buttons-fixed">
				...
				<a :href="`${backendUrl}/auth/microsoft/redirect`"><button>Mit Microsoft anmelden</button></a>
			</div>
			<div class="welcome-content">
				<div class="welcome-info">
					<h2>Job-Update System</h2>
					<p>Erfasse hier Änderungen zu Rolle, Team oder Software und Hardware von Mitarbeitenden.</p>
						...
						<ul class="features-list">
							...
							<li class="feature-item-info">
								...
								<div class="feature-content">
									...
									<span class="feature-description">Verwaltung von IT-Ressourcen und Ausstattung</span>
								</div>
							</li>
							<li class="feature-item-info">
...
const loadUserOrders = async () => {
	...
	try {
		...
		if (response.ok) {
			...
			userOrders.value = (data.orders || data).filter(order =>

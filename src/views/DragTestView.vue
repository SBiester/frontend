    ...
    <div class="main-container">
        <div class="container">
            <div class="toggle-container">
                <Toggle v-model="isEnabled" on-label="Intern" off-label="Extern" true-value="intern" false-value="extern" class="full-width-toggle" />
            </div>
